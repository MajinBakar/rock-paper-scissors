...
<div className='flex flex-col relative bg-neutral-200 w-[5.5rem] h-[4.5rem] sm:w-[10rem] sm:h-[8rem] rounded-lg items-center'>
    ...
    <p className='flex absolute cursor-pointer bottom-[0.1rem] right-2 text-[0.6rem] text-red-600' onClick={() => {localStorage.clear();window.location.reload();}}>RESET SCORE</p>
</div>
    </div>   
  )
}
